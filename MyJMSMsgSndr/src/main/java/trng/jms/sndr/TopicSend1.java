...
public class TopicSend1
{
  ...
  // Defines the topic.
  public final static String TOPIC="jms/TestJMSTopic";
...
/**
  ...
  */
  protected static void readAndSend(TopicSend1 ts)
